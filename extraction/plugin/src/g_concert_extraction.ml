let __coq_plugin_name = "coq-concert-extraction.plugin"
let _ = Mltop.add_known_module __coq_plugin_name

# 3 "src/g_concert_extraction.mlg"
...
let () = Vernacextend.vernac_extend ~command:"ConCertExtract" ~classifier:(fun _ -> Vernacextend.classify_as_query) ?entry:None 
         [(Vernacextend.TyML (false, Vernacextend.TyTerminal ("ConCert", 
...
# 114 "src/g_concert_extraction.mlg"
